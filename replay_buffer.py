...
class ReplayBuffer(object):
    ...
    def add(self, obs_t, action, reward, obs_tp1, done, adv):
        data = (obs_t, action, reward, obs_tp1, done, adv)
    ...
    def _encode_sample(self, idxes):
        obses_t, actions, rewards, obses_tp1, dones, advs = [], [], [], [], [], []
        for i in idxes:
            data = self._storage[i]
            obs_t, action, reward, obs_tp1, done, adv = data
...
class PrioritizedReplayBuffer(ReplayBuffer):
    ...
    def add(self, *args, **kwargs):
        ...
        idx = self._next_idx
        super(ReplayBuffer).add(*args, **kwargs)
